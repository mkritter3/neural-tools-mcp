...
# L9 COMPLIANT: Use shared utilities instead of duplicated functions
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', 'hook_utils'))
...
class SemanticMemoryExtractor:
    ...
    def __init__(self, max_tokens: int = 2000):
        ...
        # L9 COMPLIANT: Use shared utilities instead of duplicated pattern definitions
