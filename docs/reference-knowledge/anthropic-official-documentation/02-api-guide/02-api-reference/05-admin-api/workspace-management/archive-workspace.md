...
````yaml post /v1/organizations/workspaces/{workspace_id}/archive
paths:
  ...
  request:
    ...
    codeSamples:
      - lang: bash
        source: >-
          curl --request POST
          "https://api.anthropic.com/v1/organizations/workspaces/wrkspc_01JwQvzr7rXLA5AGx3HKfFUJ/archive"
          \
              ...
              created_at:
                allOf:
                  - type: string
                    ...
                    title: Created At
                    description: >-
                      RFC 3339 datetime string indicating when the Workspace was
                      created.
                    examples:
              ...
              archived_at:
                allOf:
                  - anyOf:
                    ...
                    description: >-
                      RFC 3339 datetime string indicating when the Workspace was
                      archived, or null if the Workspace is not archived.
                    examples:
              ...
              display_color:
                allOf:
                  - type: string
                    title: Display Color
                    description: >-
                      Hex color code representing the Workspace in the Anthropic
                      Console.
                    examples:
                      - '#6C5BB9'
            title: Workspace
