...
````yaml post /v1/organizations/workspaces/{workspace_id}/members
paths:
  ...
  request:
          ...
          - type: object
            properties:
              ...
              workspace_role:
                allOf:
                  - allOf:
                      - $ref: '#/components/schemas/NoBillingWorkspaceRoleSchema'
                    description: >-
                      Role of the new Workspace Member. Cannot be
                      "workspace_billing".
            required: true
            title: CreateWorkspaceMemberParams
            requiredProperties:
              - user_id
              - workspace_role
    ...
    codeSamples:
      - lang: bash
        source: >-
          curl
          "https://api.anthropic.com/v1/organizations/workspaces/wrkspc_01JwQvzr7rXLA5AGx3HKfFUJ/members"
          \
...
components:
  schemas:
    ...
    NoBillingWorkspaceRoleSchema:
      type: string
      enum:
        - workspace_user
        - workspace_developer
        - workspace_admin
      title: NoBillingWorkspaceRoleSchema
    NotFoundError:
      properties:
        type:
          type: string
