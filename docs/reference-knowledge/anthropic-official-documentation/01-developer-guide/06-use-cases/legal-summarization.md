...
def summarize_document(text, details_to_extract, model="claude-opus-4-1-20250805", max_tokens=1000):
...
def summarize_long_document(text, details_to_extract, model="claude-opus-4-1-20250805", max_tokens=1000):
