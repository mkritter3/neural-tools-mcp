...
**DON'T CREATE NEW FILES LIKE "Enhanced", V2, V3, etc.  OR WHATEVER. EDIT THE EXISTING FILES. THAT'S WHAT GIT BRANCHES ARE FOR**
...
**DEFINE FUNCTIONS ONLY ONCE! DO NOT REPEAT YOURSELF BY DEFINING THE FUNCTION MULTIPLE TIMES**
**REMEMBER YOU CODING PRINCIPLES: DRY (Don't Repeat Yourself), KISS (Keep It Simple, Stupid!), YAGNI (You Aren't Gonna Need It), Curly's Law (Do One Thing) Each class or Function should have a single, clearly defined goal or purpose**
